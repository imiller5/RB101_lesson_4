...
# 1. Create an empty 'row' arry to contain all of the rows
# 2. Create a 'row' array and add it to the overall rows array
# 3. Repeat step 2 until all the necessary rows have been created
#   - All rows have been created when the length of the 'rows' array is equal to the input integers
# 4. Sum the final row
# 5. Return the sum
...
# 1. Create an empty 'row' to conatin the integers
